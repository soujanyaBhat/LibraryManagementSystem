...
if (mysqli_num_rows($result) > 0)
{
  ...
  {
    echo "<tr><td>".$row1["isbn"]."</td><td>".$row1["title"]."</td><td>".$row1["availability"]."</td><td><a href='addCartAdmin.php?id=".$row1['isbn']."&title=".$row1['title']."&author=".$row1['author']."&availability=".$row1['availability']."'>Add to cart</a><br>
