...
.lib a:hover:not(.active){background-color: green;}
</style>
...
$sql2= "SELECT isbn,title,picture from book where category='$query' and availability='1';";
...
for($b=1;$b<=$a;$b++)
{
    ?><div class='lib'><a href="userfunctionality.php?page=<?php echo $b; ?>"style="text-decoration: underline"><?php echo $b." "; ?></a></div><?php
}
mysqli_close($conn);
?>
</body>
