...
?>
<a href="usercart.php" method="post"><img src="back.jpg" alt="Back" align="left" style="width: 30px"></a>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  while($row1 = mysqli_fetch_array($result))
  {
    ...
    "</td><td><a href='checkoutuser.php?id=".$row1['isbn']."&title=".$row1['title']."&author=".$row1['author']."&availability=".$row1['availability']."'>Borrow</a><br>
				<a href='removeuser.php?id=".$row1['isbn']."&title=".$row1['title']."&author=".$row1['author']."&availability=".$row1['availability']."'>Remove</a></td></tr>";
