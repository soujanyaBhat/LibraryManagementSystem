...
<tr>
  <td style="width:25%"><?php echo "<form  action='addtoadminwishlist.php' method='post'>
  <input type='submit' name='isbn' value='Add to wish list' onclick='this.form.submit()'/></form>";?></td>
  <td style="width:25%"><?php echo "<form  action='updateRecord.php' method='post'>
  <input type='submit' name='isbn' value='Update book details' onclick='this.form.submit()'/></form>";?></td>
  <td style="width:25%"><?php echo "<form  action='detelebook.php' method='post'>
  <input type='submit' name='isbn' value='Delete' onclick='this.form.submit()'/></form>";?></td></tr></table>
<div class="footer">
